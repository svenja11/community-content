...
Für das automatische Importieren von entfernten IMAP-Konten auf Mailboxen in ihrem Webhosting, kann der [Mailimport](https://docs.hetzner.com/de/konsoleh/account-management/email/mailimport) verwendet werden. 

Wenn Sie viele Mailboxen oder Weiterleitungen anlegen möchten, ohne IMAP-Konten zu importieren, können Sie ein Ticket erstellen.
