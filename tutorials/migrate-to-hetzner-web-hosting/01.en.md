...
For the automatic import of removed IMAP accounts to mailboxes in your webhosting, you can use the [mailimport](https://docs.hetzner.com/konsoleh/account-management/email/mailimport).

To set up many mailboxes or forwarding without importing IMAP accounts, you can create a support request.
