...
> **Hinweis:** Sollte auch mit Debian 13 (`Debian-1305-trixie-amd64-base.tar.zst`) funktionieren — allerdings ohne Garantie. Mit `ls /root/images` wird eine liste verfügbarer Images gelistet.
